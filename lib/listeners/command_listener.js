const globalStateService = require('../services/global_state_service')

function toggleBotOn(message) {
  globalStateService.toggleOn()
...
function showCurrentStatus(message) {
  message.channel.send(`Parapipa parapupa está: ${globalStateService.currenState()}`)
}
